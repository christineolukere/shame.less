        ...
        >
          ...
          <div className="space-y-6">
            <div className="bg-terracotta-50 rounded-2xl p-6 border border-terracotta-100">
              <h3 className="font-serif text-terracotta-800 mb-3">About shame.less</h3>
              <p className="text-terracotta-700 text-sm leading-relaxed">
                <strong>shame.less is not a replacement for professional therapy or medical advice.</strong> 
            ...
            <div className="bg-lavender-50 rounded-2xl p-6 border border-lavender-100">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="font-serif text-lavender-800">Crisis Support</h3>
              </div>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between items-center p-2 bg-lavender-100 rounded-lg">
                  ...
                  <span className="text-lavender-700">Text HOME to 741741</span>
                </div>
                <div className="flex justify-between items-center p-2 bg-lavender-100 rounded-lg">
                  <span className="text-lavender-800 font-medium">Suicide Prevention</span>
                  <span className="text-lavender-700">Call or text 988</span>
                </div>
                <div className="flex justify-between items-center p-2 bg-lavender-100 rounded-lg">
                  <span className="text-lavender-800 font-medium">Emergency</span>
                  <span className="text-lavender-700">Call 911</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-sage-50 rounded-2xl p-6 border border-sage-100 text-center">
              ...
              <p className="text-sage-700 text-sm leading-relaxed">
                You deserve support, love, and professional care when you need it. 
                This app is here to complement your healing journey, not replace professional help.
              </p>
            </div>
